      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-2">
          ...
          {!user ? (
            ...
            <div className="flex items-center gap-2">
              <Link to="/profile" className="inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-slate-700 border border-slate-200 hover:bg-slate-50">
